...
const exactAttributes = {
  ...
  '例如：价格咨询跟进': 'e.g. Pricing inquiry follow-up',
  '例如：客户询问价格后': 'e.g. After a customer asks about pricing',
  '审核并修改可直接使用的话术': 'Review and edit the reusable sales script',
  '客户常问的问题': 'A common customer question',
  '审核并修改标准答复': 'Review and edit the standard reply',
  '客户可能提出的顾虑': 'A concern the customer may raise',
  '审核并修改应对话术': 'Review and edit the objection response',
  '例如：张老师': 'e.g. Alex',
